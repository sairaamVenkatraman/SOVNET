...
def train_test(baseline,num_epochs,train_loaders_desc,test_loaders_desc):
    for (train_loader, train_loader_desc) in train_loaders_desc:
        ...
        exp_lr_scheduler = lr_scheduler.LambdaLR(optimizer,lambda epoch: 0.5**(epoch // 10))
...
def main_loop():
    ...
    num_epochs = 150
    train_translation_rotation_list = [((0,0),0),((0.033,0.033),30),((0.033,0.033),60),((0.033,0.033),90),((0.033,0.033),180)]
    test_translation_rotation_list = [((0,0),0),((0.033,0.033),30),((0.033,0.033),60),((0.033,0.033),90),((0.033,0.033),180)]
