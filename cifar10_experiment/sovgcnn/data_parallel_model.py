...
class P4InitialConvResidualBlock(nn.Module):
  '''A residual block'''
...
class P4ResidualBlock(nn.Module):
...
class PrimaryCapsules(nn.Module):
  ...
  def __init__(self,num_capsules=10,in_channels=32,out_channels=32):
    ...
    #                              P4ConvP4(in_channels,in_channels,3,1,1),
    #                              nn.BatchNorm3d(in_channels),
    #                              P4ConvP4(in_channels,in_channels*num_capsules,3,1,1),
    #                              nn.BatchNorm3d(in_channels*num_capsules),
    #                              P4ConvP4(in_channels*num_capsules,in_channels*num_capsules,5),        
...
class P4PoolingCapsules(nn.Module):
  ...
  '''
  def __init__(self,num_capsules,capsule_dim,kernel_size,stride=1,padding=0):
...
class GcnnSovnet(nn.Module):
  def __init__(self):
    ...
    #(batch_size,3,64,64)
    self.initial_conv = P4BasicBlock(out_planes=16)
    #(batch_size,32,31,31)  
    self.primary_capsules = PrimaryCapsules(num_capsules=5,in_channels=16,out_channels=32)
    #(batch_size,5,32,4,31,31) 
    self.hidden_capsules1 = ConvolutionalCapsules(num_in_capsules=5,in_capsule_dim=32,num_out_capsules=5,out_capsule_dim=32,kernel_size=3,stride=2)
    #(batch_size,5,32,4,15,15)
    self.hidden_capsules2 = ConvolutionalCapsules(num_in_capsules=5,in_capsule_dim=32,num_out_capsules=5,out_capsule_dim=32,kernel_size=3)
    #(batch_size,5,32,4,13,13)
    self.hidden_capsules3 = ConvolutionalCapsules(num_in_capsules=5,in_capsule_dim=32,num_out_capsules=5,out_capsule_dim=32,kernel_size=5)
    #(batch_size,5,32,4,9,9)
    self.hidden_capsules4 = ConvolutionalCapsules(num_in_capsules=5,in_capsule_dim=32,num_out_capsules=5,out_capsule_dim=32,kernel_size=3,stride=1,padding=1)
    #(batch_size,5,32,4,9,9)
    self.hidden_capsules5 = ConvolutionalCapsules(num_in_capsules=5,in_capsule_dim=32,num_out_capsules=5,out_capsule_dim=32,kernel_size=5)
    #(batch_size,5,32,4,5,5)
    self.hidden_capsules6 = ConvolutionalCapsules(num_in_capsules=5,in_capsule_dim=32,num_out_capsules=5,out_capsule_dim=32,kernel_size=3)
    #(batch_size,10,32,4,3,3)  
    self.class_capsules = ConvolutionalCapsules(num_in_capsules=5,in_capsule_dim=32,num_out_capsules=10,out_capsule_dim=32,kernel_size=3)
    #(batch_size,10,32,4,1,1)
    self.reconstruction_layer = ReconstructionLayer(10,32,64,3)
    #(batch_size,3,64,64)
