...
SAVEPATH = "./check_points/FashionMNIST/"
BATCHSIZE = 64
INDEX_OF_TRAIN_TRIALS = 1
NUMBER_OF_TEST_TRIALS = 1

def get_model(desc):
    if desc == 'SimpleGcnnsovnet':
       model = GcnnSovnet()
...
def main_loop():
    baselines = ['SimpleGcnnsovnet']
    num_epochs = 150
    train_translation_rotation_list = [((0,0),0)]#,((0.075,0.075),30),((0.075,0.075),60),((0.075,0.075),90),((0.075,0.075),180)]
    test_translation_rotation_list = [((0,0),0),((0,0),90),((0,0),180),((0,0),270)]#,((0.075,0.075),30),((0.075,0.075),60),((0.075,0.075),90),((0.075,0.075),180)]
