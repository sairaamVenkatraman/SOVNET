...
class GcnnSovnet(nn.Module):
  def __init__(self):
    ...
    #(batch_size,32,4,13,13)
    self.primary_capsules = PrimaryCapsules(num_capsules=8,in_channels=32,out_channels=16)
    #(batch_size,8,16,4,13,13) 
    self.hidden_capsules_one = ConvolutionalCapsules(num_in_capsules=8,in_capsule_dim=16,num_out_capsules=8,out_capsule_dim=16,kernel_size=3)
    #(batch_size,8,16,4,11,11)
    self.hidden_capsules_two = ConvolutionalCapsules(num_in_capsules=8,in_capsule_dim=16,num_out_capsules=8,out_capsule_dim=16,kernel_size=3,stride=1,padding=1)
    #(batch_size,8,16,4,11,11)
    self.hidden_capsules_three = ConvolutionalCapsules(num_in_capsules=8,in_capsule_dim=16,num_out_capsules=8,out_capsule_dim=16,kernel_size=5)
    #(batch_size,8,16,4,7,7)
    self.hidden_capsules_four = ConvolutionalCapsules(num_in_capsules=8,in_capsule_dim=16,num_out_capsules=8,out_capsule_dim=16,kernel_size=3,stride=1,padding=1)
    #(batch_size,8,16,4,7,7)
    self.hidden_capsules_five = ConvolutionalCapsules(num_in_capsules=8,in_capsule_dim=16,num_out_capsules=8,out_capsule_dim=16,kernel_size=5)
    #(batch_size,8,16,4,3,3)
    self.class_capsules = ConvolutionalCapsules(num_in_capsules=8,in_capsule_dim=16,num_out_capsules=10,out_capsule_dim=16,kernel_size=3)
    #(batch_size,10,16,4,1,1)
    self.reconstruction_layer = ReconstructionLayer(10,16,28,1)
    #(batch_size,1,28,28)
