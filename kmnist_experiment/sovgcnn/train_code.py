...
def main_loop():
    ...
    num_epochs = 150
    train_translation_rotation_list = [((0.1,0.1),10)]
    test_translation_rotation_list = [((0,0),0)]
    train_loaders_desc, test_loaders_desc = get_loaders_kmnist(train_translation_rotation_list,test_translation_rotation_list,BATCHSIZE)  
